...
type WrapperConstructor<T extends string, S extends string, H extends number, R extends any = void> = (underlying: Error, classification: TypeSubtype$1<T, S>, options?: {
    message?: string;
    httpErrorCode?: H;
}) => R;
type StandardConstructor<T extends string, S extends string, H extends number, R extends any = void> = (message: string, classification: TypeSubtype$1<T, S>, options?: IErrorRuntimeOptions<H> | undefined) => R;
...
type TypeSubtype<T extends string, S extends string> = TypeSubtype$1<T, S>;

declare function isBrilliantError(error: unknown): error is IBrilliantError<any, any, any, any, any, any>;
type BrillianErrorTypeGuard = typeof isBrilliantError;
